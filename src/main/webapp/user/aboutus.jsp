...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/css/about_us.css">
</head>
    ...
    <div class="title-person-bill-notification">
        <div class="head-warp">
            <div class="head">
                ...
                <div class="main-nav">
                    <a class="nav-index" href="javaScript:void(0)">首页</a> <a class="nav-index" href="javaScript:void(0)">余额宝</a> <a class="nav-index" href="javaScript:void(0)">关于我们</a> <a class="text-login" href="login01.html"> <span class="avata">
        ...
        <hr>
        <div class="center">About us
            <div class="center_left">Zero</div>
            <div class="center_right"></div>
            <div class="center_left_one">&nbsp;&nbsp;人这一辈子，可以有理想，可以有梦想，也可以痴心妄想，就是不可以什么都不想。&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; ----选择理财,过不一样的生活
            </div>
            <div class="center_left_two">
                &nbsp;&nbsp;人只能活一回，梦想却有无数个，唯有放手一搏，才能知道机会属不属于自己。 &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;-----理财精灵，是你的选择
            </div>
        </div>
        <div class="footer">
